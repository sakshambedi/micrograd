...
class TestAddition:
    ...
    # Broadcasting tests removed - feature not yet implemented
...
class TestSubtraction:
    ...
    #     np.testing.assert_array_equal(out.to_numpy(), expected)
    #
    # def test_broadcast_sub_mismatched(self):
    #     t0 = Tensor.ones((2, 3))
    #     t1 = Tensor.arange(3)
    #     out = t0 - t1
    #     expected = np.ones((2, 3)) - np.arange(3)
...
class TestMultiplication:
    ...
    #     np.testing.assert_array_equal(out.to_numpy(), expected)
    #
    # def test_broadcast_mul_mismatched(self):
    #     t0 = Tensor.ones((2, 3))
    #     t1 = Tensor.arange(3)
    #     out = t0 * t1
    #     expected = np.ones((2, 3)) * np.arange(3)
...
class TestDivision:
    ...
    #     t0 = Tensor.ones((3, 1)) * 6
    #     t1 = Tensor.arange(1, 4)  # [1, 2, 3]
    #     out = t0 / t1
    #     expected = np.ones((3, 1)) * 6 / np.arange(1, 4)
    #     np.testing.assert_array_equal(out.to_numpy(), expected)
    #
    # def test_broadcast_div_mismatched(self):
    #     t0 = Tensor.ones((2, 3)) * 10
    #     t1 = Tensor.arange(1, 4)  # [1, 2, 3]
    #     out = t0 / t1
    #     expected = np.ones((2, 3)) * 10 / np.arange(1, 4)
    #     np.testing.assert_array_equal(out.to_numpy(), expected)
...
# Power operation not yet implemented
# class TestPower:
#     @pytest.mark.parametrize(
#         "a,b",
#         [
...
#         np.testing.assert_array_equal(out.to_numpy(), expected)
#
#     # Broadcasting test removed - feature not yet implemented
#     # def test_broadcast_pow(self):
#     #     t0 = Tensor.ones((3, 1)) * 2
#     #     t1 = Tensor.arange(1, 4)  # [1, 2, 3]
#     #     out = t0**t1
#     #     expected = (np.ones((3, 1)) * 2) ** np.arange(1, 4)
#     #     np.testing.assert_array_equal(out.to_numpy(), expected)
#
